...
/**
 * @description takes value of input box and returns it back to parent as input through function in properties * @param  {requestCallBack} - gets input from change in input box
 * @return {string}
 */
	      change(event) {
